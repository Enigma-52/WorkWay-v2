...
const Footer: React.FC = () => {
  return (
    <footer className="mt-16 border-t border-gray-700 pt-8" role="contentinfo">
      <nav
      ...
      >
        <div>
          ...
          <p className="text-gray-400">
            WorkWay is your gateway to exciting career opportunities. We connect
            talented professionals with leading companies worldwide.
          </p>
        </div>
        ...
        <div>
          <h2 className="text-xl font-semibold mb-4">Connect with the Maker</h2>
